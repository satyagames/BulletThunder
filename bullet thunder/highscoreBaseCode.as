...
_global.setupHighscoreSubmission = function (_ref) {
	_ref.submitScoreBtnClip.onRelease = function() {
...
removeDarkener();
		...
		_ref.submitScoreBtnClip._visible = false;
	};
}
_global.showHighscores = function () {
